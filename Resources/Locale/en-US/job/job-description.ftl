...
job-description-inmate-cook = Learn the basics of knife safety. Use the forbidden sauce when Chef isn't looking.
job-description-inmate-nurse = Keep your fellow inmates healthy. Weather suspicious looks when chemicals go missing.
job-description-inmate-technician = Make repairs, wire up electronics, and be the first one accused of any sabotage aboard the station.
...
job-description-test-subject = Work off your sentence by volunteering for the most dangerous experiments.
